...
<div
    ...
    <h2 class="my-1 gradient-red text-base uppercase tracking-wide">Animated &amp; Responsive</h2>
    <p class="py-2 text-center text-sm">What makes Fancy Tailwind awesome is that our Tailwind CSS components are -
        for the most - animated, beautiful and responsive, which make them so cool.</p>
</div>
...
<div
    ...
    <h2 class="my-1 gradient-red text-base uppercase tracking-wide">Copy code &amp; Paste</h2>
    <p class="py-2 text-center text-sm">Simply copy and paste the code I provide to implement Fancy Tailwind
        components in your projects.</p>
</div>
...
<div
    ...
    <h2 class="my-1 gradient-red text-base uppercase tracking-wide">Instructions</h2>
    <p class="py-2 text-center text-sm">Some of the components require fews modifications in your Tailwind config or
