    ...
    <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
      <div class="lg:pr-8 lg:pt-4">
        <div class="lg:max-w-lg">
          <h2 class="text-base font-semibold leading-7 text-white">Produce faster</h2>
          <p class="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">An Enterprise API</p>
          <p class="mt-6 text-lg leading-8 text-white">We've built an API that allows you to scale your podcast
            production workflow.
          </p>
          <dl class="mt-10 max-w-xl space-y-8 text-base leading-7 text-white lg:max-w-none">
            <div class="relative pl-9">
              <dt class="inline font-semibold text-white"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                  fill="currentColor" aria-hidden="true" class="absolute left-1 top-1 h-5 w-5 text-white">
                  <path
        ...
        <div class="mt-10 flex items-center gap-x-6">
          ...
          <a href="#" class="text-sm font-semibold leading-6 text-white">Schedule a demo
