...
const WaterlilyLanding = () => {
    return (
        <div>
             <section class="mb-40  waterlanding   ">
  {/* <!-- Navbar --> */}
  ...
  {/* <!-- SVG Background --> */}
    ...
    <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" height="800"
  ...
  {/* <!-- Jumbotron --> */}
  <div class="  w-100 py-10 mx-auto px-6 sm:max-w-2xl md:max-w-3xl md:px-12 lg:max-w-5xl xl:max-w-7xl xl:px-32">
    <div class="text-center   ">
      <div
        class="  block  rounded-lg   px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[hsla(0,0%,15%,0.8)] dark:shadow-black/20 md:py-16 md:px-12"
        >
        <h1 class="mt-6 mb-16 text-5xl font-bold text-white tracking-tight md:text-6xl xl:text-7xl">
          The best offer on the market <br /><span class="text-white">for your program</span>
        </h1>
...
export default WaterlilyLanding;